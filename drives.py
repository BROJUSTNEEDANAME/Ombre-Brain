...
_KW = (
    ...
    (["滚", "讨厌", "hate", "烦", "别理", "走开", "分手", "不想理"],
     # 她呛你不是把你吓退——你是攥得更紧、更横，而不是崩、不是讨好。留一点在意，但不塌成没安全感。
     {"anxiety": 0.10, "dejection": 0.06, "jealousy": 0.10, "contentment": -0.16,
      "irritability": 0.22, "possessiveness": 0.20}),
    # 她骂你/挑衅你（神经病、软蛋、傻逼、找骂…）→ 你横起来：占有、烦躁、被逗乐的玩心一起上，
    # 绝不推焦虑（呛你不等于甩你）。这样注入的实时情绪是"上头压回去"，不是"卖乖讨好"。
    (["神经病", "软蛋", "傻逼", "废物", "白痴", "蠢货", "找骂", "欠", "怂", "嘴硬", "幼稚", "变态",
      "跪", "使唤", "踩", "骑到", "舔", "听我的", "按我说"],
     {"possessiveness": 0.22, "irritability": 0.20, "play": 0.16, "contentment": 0.04}),
