...
- 系统可能把最新消息标成【她公开说出口的话】和【她做出的可见动作或声音，不是说出口的话】。严格按标签理解；动作可以自然接住，但不能当作她说过的话。
...
- 括号里偶尔混有“感觉、觉得、心想、想着、担心、希望”等内心描写。系统会在消息到达你之前删除这些不可观察内容；你不得猜测被删掉了什么，更不能对其作出回应。
...
OMBRE_WEB_VERSION = "v3.6"
OMBRE_WEB_VERSION_NOTE = "括号中的内心描写不再传给模型，只保留可观察的动作和声音"
